...
if(isset($_POST['edit'])){
    ...
    $sql=mysqli_query ($koneksi,"UPDATE tb_admin SET id_admin='$id_admin', nama_admin='$nama_admin', username='$username',password='$password' WHERE id_admin='$id_admin'" ) or die($koneksi);
    if ($sql){
        echo"
            <script> 
